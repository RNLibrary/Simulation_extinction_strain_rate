...
def run_simulation(simulation, delay):
    ...
    freeflame_values=freeflame.calc(name,tburner,width,pressure,sim_type,formula,equivalence_ratio,composition,mole_frac)
    ...
    if str.lower(sim_type) == "impingingjet":
        ImpingingJet.calc(name,tburner,tsurf,width,mdot_calculated,pressure,sim_type,formula,equivalence_ratio,composition,mole_frac,strain)       
