...
def calc(name,tburner,width,pressure,sim_type,formula,equivalence_ratio,composition,mole_frac):
    ...
    strain=f.velocity[0]/thickness
    vel=strain*width
    mdot_calculated= rho_f*vel

        

    return mdot_calculated,strain
